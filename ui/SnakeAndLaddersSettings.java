 ...
 * @author mainmhl
 */
public class SnakeAndLaddersSettings {
    
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ class c++
    //static SnakeAndLadders othello;
    
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    static final int MAXPLAYERSNUM = 100;
    
    static int playerNum = 1;           // if the game is with computer it is 1 else number of players
    ...
    static Color player1Color = Color.BLACK;
    
    static Color player2Color = Color.SKYBLUE;
    ...
    public SnakeAndLaddersSettings() {
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ class c++
        //othello = new SnakeAndLadders();
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        nextButton.setOnAction(e -> {                                           // computer player setting(2)
            ...
            if (choice.equals("computer")) {
                playaerType = -2;
                UI.sceneArray.push(SnakeAndLaddersSettings.scene);
                SnakeAndLaddersComputerSettings snakeAndLaddersComputerSettings = new SnakeAndLaddersComputerSettings();
                UI.window.setScene(SnakeAndLaddersComputerSettings.scene);
            } else {
                playaerType = 0;
                UI.sceneArray.push(SnakeAndLaddersSettings.scene);
                SnakeAndLaddersHumanSettings snakeAndLaddersHumanSettings = new SnakeAndLaddersHumanSettings();
                UI.window.setScene(SnakeAndLaddersHumanSettings.scene);
            }
        });
