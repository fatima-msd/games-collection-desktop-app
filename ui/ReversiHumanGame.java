...
public class ReversiHumanGame {
    ...
    public ReversiHumanGame() {
        
        this.playersNames[0] = ReversiHumanSettings.playersNames[0];
        this.playersNames[1] = ReversiHumanSettings.playersNames[1];
